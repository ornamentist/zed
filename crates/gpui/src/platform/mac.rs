...
pub fn key_to_native(key: &str) -> Cow<'_, str> {
    ...
    let code = match key {
        ...
        "numpad_asterisk" => b'*' as u16,
        "numpad_slash" => b'/' as u16,
...
unsafe fn parse_keystroke(native_event: id) -> Keystroke {
    unsafe {
        ...
        let numpad = modifiers.contains(NSEventModifierFlags::NSEventModifierFlagNumericPad);
        ...
        let key = match first_char {
            ...
            Some(NUMPAD_ENTER_KEY) => {
                  key_char = Some("\n".to_string());
                  if numpad {
                      "numpad_enter".to_string()
                  } else {
                      "enter".to_string()
                  }
             }
            ...
            _ => {
                ...
                let mut key = if shift
                  ...
                  // Handle numpad keys by prefixing with "numpad_" when the 
                  // numpad modifier flag is set
                  if numpad {
                      match key.as_str() {
                          "0" => "numpad_0".to_string(),
                          "1" => "numpad_1".to_string(),
                          "2" => "numpad_2".to_string(),
                          "3" => "numpad_3".to_string(),
                          "4" => "numpad_4".to_string(),
                          "5" => "numpad_5".to_string(),
                          "6" => "numpad_6".to_string(),
                          "7" => "numpad_7".to_string(),
                          "8" => "numpad_8".to_string(),
                          "9" => "numpad_9".to_string(),
                          "+" => "numpad_plus".to_string(),
                          "-" => "numpad_minus".to_string(),
                          "*" => "numpad_asterisk".to_string(),
                          "/" => "numpad_slash".to_string(),
                          "." => "numpad_decimal".to_string(),
                          "=" => "numpad_equals".to_string(),
                          _ => key,
                      }
                  } else {
                      key
